...
* コンペ概要・制約・提出仕様の要約は [About\_Competition.md](/Users/minorisugimura/GitHub/soccerNet2026/About_Competition.md) を参照すること．
...
* 可能な限り，英語の単語には日本語での説明も添えること．最初から日本語で書いてもよい．ただし，`COCO`，`HOTA` のように CV 業界で広く通じる語や固有名詞はそのまま使ってよい．

* 専門用語は抽象的に置かず，ドキュメント内の例や具体的な状況を使って，可能な限り分かりやすく説明すること．
